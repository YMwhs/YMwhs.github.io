...
## Global variables
The global variables I will use firstly is time, in order to keep track of the user for the 5 hours(in minutes, 300) they have. Secondly their will be a boolean for if they just went on a ride and if they just ate food, if they went on a ride then went to get food it will check if that boolean is true, and if it is then they throw up and lose the game. Lastly, their will be a ride counter for each ride they go on and a food counter for how much food they've eaten, if they don't go on atleast 4 rides and has eaten 2 foods, then they leave dissapointed and technically lose the game.
